...
/**
 * Class used to capture the fact the {@link ToFileRunNotifier} was called. An
 * instance of this class represents a single call to the notifier. When the
...
public class Notification implements Serializable {
	 ...
	 * notifier. But it is easier to carry the array of objects as it matches the
	 * expected format of the {@link Method#invoke(Object, Object...)} method used
	 * when re-making the calls to the notifier in {@link MpiRunner}.
	 */
	 ...
	 * Constructor.
	 *
	 * Builds a Notification object that represents the fact that a method of the
	 * class {@link ToFileRunNotifier} was called.
	 *
